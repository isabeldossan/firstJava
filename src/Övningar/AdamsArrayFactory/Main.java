...
public class Main {
    public static void main(String[] args) {
        ...
        String savedStrings = ""; //<-- vi deklarerar en tom String utanför vår While loop.
        while (true){
        ...
        factory.printMyArray();                // <-- Vi skriver även här innan vi bryter loopen effekten av våra beräkningar, detta går även att göra efter vår while-loop.
